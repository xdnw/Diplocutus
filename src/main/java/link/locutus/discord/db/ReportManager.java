...
public class ReportManager {
    ...
    public static class Report {
        ...
        public String toMarkdown(boolean includeComments) {
            ...
            String reporterNationLink = DNS.getMarkdownUrl(reporterNationId, false);
            String reporterAllianceLink = DNS.getMarkdownUrl(reporterAllianceId, true);
        ...
        public String getTitle() {
            String msg = "";
            if (nationId != 0) {
                msg += DNS.getName(nationId, false);
            }
            if (discordId != 0) {
                if (!msg.isEmpty()) msg += " | ";
    ...
    public static class Comment {
        ...
        public String toMarkdown() {
            ...
            msg.append("(by: " + DNS.getName(nationId, false) + " | " + DiscordUtil.getUserName(discordId) + "):\n");
