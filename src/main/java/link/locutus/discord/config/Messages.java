...
public class Messages {
    ...
    public static String CITY_URL = "" + Settings.INSTANCE.DNS_URL() + "/city/id=";

    public static String NATION_URL = "" + Settings.INSTANCE.DNS_URL() + "/nation/id=";
    public static String ALLIANCE_URL = "" + Settings.INSTANCE.DNS_URL() + "/alliance/id=";
    ...
    public static String TAB_TYPE = "Tab `{tab_name}` is not a valid type. Use e.g. `nation:YOUR_SELECTION`\n" +
            "See: <https://github.com/xdnw/diplocutus/wiki/custom_spreadsheets#selection-types>";
}