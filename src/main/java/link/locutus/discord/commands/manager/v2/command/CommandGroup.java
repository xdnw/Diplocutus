...
//        return null;
    ...
    public void registerCommandsWithMapping(Class<CM> remapping, boolean ignoreMissing) {
        Map<Class<?>, Object> instanceCache = new HashMap<>();
        register(remapping, new ArrayList<>(), instanceCache, true, ignoreMissing);
...
//        }
    ...
    private void register(Class<?> clazz, List<String> path, Map<Class<?>, Object> instanceCache, boolean isRoot, boolean ignoreMissing) {
        ...
        for (Class<?> subClass : clazz.getDeclaredClasses()) {
            register(subClass, subPath, instanceCache, false, ignoreMissing);
        }
    }
