...
//                    int CAL_YEAR = Calendar.YEAR;
    ...
    public static long getHour() {
        ...
        int turnsPerDay = 24;
        return (hoursInCurrentDay) + daysSince0 * turnsPerDay;
    }
    ...
    public static long getDayFromHour(long hour) {
        return hour / 24;
    }

    public static long getHour(long timeStampMillis) {
        return TimeUnit.MILLISECONDS.toHours(timeStampMillis);
    }

    public static long getOrigin() {
        return 1577840461000L;
    }

    public static long getTimeFromHour(long hour) {
        long day = (hour / 24);
        hour = hour - (day * 24);
