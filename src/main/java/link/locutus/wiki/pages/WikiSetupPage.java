...
public class WikiSetupPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        return build(
                """
                Locutus is a bot on the discord server which assists with war calculations and alliance affairs for the game Diplomacy and Strife.
                                    
                Support Server: [<kbd> <br> Discord Support Server <br> </kbd>][Link]
                                
                [Link]: https://discord.gg/cUuskPDrB7 'Discord Support Server'
                                    
                Created by Borg (nation: <https://diplomacyandstrife.com/nation/3963> discord: `xdnw` )""",
                "# Inviting the bot to your discord server",
                """
                Click this link:
                https://discord.com/oauth2/authorize?client_id=1283157592771657858&permissions=395606879321&scope=bot
                """,
                ...
                "Example:",
                CM.register.cmd.nation("https://diplomacyandstrife.com/nation/3963").toSlashCommand(true),
