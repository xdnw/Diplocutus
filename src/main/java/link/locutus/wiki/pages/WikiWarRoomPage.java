...
public class WikiWarRoomPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        return build(
                ...
                "Users must be registered with the bot: " + CM.register.cmd.nation("").toString(),
                ...
                CM.settings_war_room.ENABLE_WAR_ROOMS.cmd.enabled("true").toString(),
                "# Using a war server",
                ...
                "1. Disable war rooms in your main server: " + CM.settings_war_room.ENABLE_WAR_ROOMS.cmd.enabled("false").toString(),
                ...
                "4. Enable war rooms in the war server: " + CM.settings_war_room.ENABLE_WAR_ROOMS.cmd.enabled("true").toString(),
                ...
                "e.g.",
                CM.war.room.create.cmd.enemy("Borg").attackers("@User").pingMembers("True").sendMail("True").toString(),
                "See: " + linkPage("counters") + " for finding, or auto assigning counters",
//                "# Category sorting", // TODO FIXME :||remove !!important
...
//                "# Generating from blitz sheet", // TODO FIXME :||remove !!important
...
//                "# Creating a sheet of war rooms", // TODO FIXME :||remove !!important
//                CM.war.counter.sheet.cmd.includeAllEnemies("True").toString(),
