...
//                commandMarkdownSpoiler(CM.conflict.sync.multiple_sources.cmd),
                ...
                "### Start/End date",
                "You may need to run " + CM.conflict.sync.website.cmd.conflicts("").reinitialize_wars("true").reinitialize_wars("true") + " after changing the start/end date",
                ...
                "You may need to run " + CM.conflict.sync.website.cmd.conflicts("").reinitialize_wars("true").reinitialize_wars("true") + " after changing the belligerents",
                ...
                CM.conflict.sync.website.cmd.conflicts("*").toString(),
                ...
                CM.conflict.sync.website.cmd.conflicts("1234").toString(),
