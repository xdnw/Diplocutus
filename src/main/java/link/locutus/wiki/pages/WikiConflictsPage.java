...
public class WikiConflictsPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        return build(
                ...
                "### Start/End date",
                "You may need to run " + CM.conflict.sync.website.cmd.conflicts("").upload_graph("true").reinitialize_wars("true").reinitialize_wars("true") + " after changing the start/end date",
                ...
                "You may need to run " + CM.conflict.sync.website.cmd.conflicts("").upload_graph("true").reinitialize_wars("true").reinitialize_wars("true") + " after changing the belligerents",
                ...
                "You may need to run " + CM.conflict.sync.website.cmd.conflicts("").upload_graph("true").reinitialize_wars("true").reinitialize_wars("true") + " after changing the start/end date",
                CM.conflict.edit.start.cmd.conflict("<conflict>").time("<time>").alliance("<alliance>").toString(),
                CM.conflict.edit.end.cmd.conflict("<conflict>").time("<time>").alliance("<alliance>").toString(),
                "### Attributes",
                ...
                CM.conflict.sync.website.cmd.conflicts("*").upload_graph("true").toString(),
                ...
                CM.conflict.sync.website.cmd.conflicts("1234").upload_graph("true").toString(),
