...
public class WikiHostingLocutus extends BotWikiGen {
    ...
    public String generateMarkdown() {
        return """
                This guide will walk you through the process of self hosting the Locutus bot (DNS). Follow the steps below to obtain the Locutus `.jar` file, run the bot, configure the `config.yaml` file, and set up the credentials for Google Sheets.
                            
                # Table of Contents
                1. [Obtaining a Diplocutus `.jar` file](#obtaining-a-locutus-jar-file)
                ...
                - [Locutus Precompiled Jar](https://github.com/xdnw/diplocutus/releases    ) (look for the file named `shadowJar-Locutus-1.0-SNAPSHOT.jar`)
                ...
                1. The Locutus source code is hosted on GitHub at [xdnw/locutus](https://github.com/xdnw/diplocutus).
                ...
                1. Download and install Java. You will need Java 22 or a newer version. You can download Java from Oracle. I use Oracle's GraalVM for its scripting and profiling support [GraalVM Download](https://www.graalvm.org/downloads/).
                   - Note: If you encounter an `UnsupportedClassVersionError`, it means you are using an outdated Java version. Install Java 22 or newer and ensure it is
